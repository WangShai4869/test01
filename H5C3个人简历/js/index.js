...
$(".content .menu").mouseenter(function () {
    $(".service").show();
})
$(function () {
...
panorama.setPosition(new BMap.Point(jd, wd)); //���ݾ�γ������չʾȫ��ͼ
panorama.setPov({heading: -40, pitch: 6});
panorama.addEventListener('position_changed', function(e){ //ȫ��ͼλ�øı����ͨ��ͼ���ĵ�Ҳ��֮�ı�
